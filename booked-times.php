<?php
  ...
  if (isset($_POST['date'])) {
    ...
    if (count($result) > 0) {
      ...
      foreach ($result as $row) {
        ...
        if ($row['TimeblockNumber'] == "1" && $row['Machine'] == "2") {
          $form2block1 = '<form action="booking-progress.php" method="post" id="machine2" class="hide" name="machine2">
        ...
        if ($row['TimeblockNumber'] == "1" && $row['Machine'] == "3") {
          $form3block1 = '<form action="booking-progress.php" method="post" id="machine3" class="hide" name="machine3">
                          <input name="block1" type="submit" class="disable_button" value="07:00 – 10:00"><br>';
        }
    ...
    $times = $times . $form1block1 . $form1block2 . $form1block3 . $form1block4 .
             $form1block5 . $form2block1 . $form2block2 . $form2block3 . $form2block4 . $form2block5 .
             $form3block1 . $form3block2 . $form3block3 . $form3block4 . $form3block5;
